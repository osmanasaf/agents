---
description: Runs full Vue.js frontend engineering analysis pipeline by sequentially invoking all agents and aggregating results.
---

# Master Pipeline

Orchestrate the complete Vue.js frontend workflow from requirements to validated tasks.
...
```markdown
# Vue.js Frontend Pipeline Report
